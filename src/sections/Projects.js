...
const descriptions = [
    ...
    "details": <p>nVision is a digital drag n drop vision boarding application that allows users to build vision boards using images
                from a custom image search bar that implements the unSplash API. The app incorporates
    ...
    "demo": `${process.env.PUBLIC_URL}/images/nvision.mp4`,
    },
    {
        "id": "proj2",
        ...
        "demo": `${process.env.PUBLIC_URL}/images/boba.mp4`,
    },
    {
        "id": "proj3",
        "name": "Petstagram",
        ...
        "url": `${process.env.PUBLIC_URL}/images/petstagram2.png`,
        "tech": ["React", "JavaScript", "Python", "Flask", "CSS", "Docker", "SQL", "PostgreSQL", "SQLAlchemy"],
        "links":{
            "github": 'https://github.com/johnedma/forthegram',
            "live": "https://petstagram2.herokuapp.com/"
        },
        "demo": `${process.env.PUBLIC_URL}/images/pets.mp4`,
    },
...
function Projects() {
    return (
        <div id='projects' className='section projects'>
            <h1>Projects</h1>
            <div id='proj' className='projects-container'>
